...
export const useTableManager = (initialParams = {}) => {
  ...
  const { pageNumber, pageSize, goToPage, handleSetPageSize, searchTerm, toggleSortType, handleSetSortBy, params, handleSetSearch, searchPlaceholder } = useBasicTableFilterHelper(initialParams)
