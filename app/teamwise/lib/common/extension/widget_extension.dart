...
extension StyledWidget on Widget {
  ...
  Widget alignment(AlignmentGeometry alignment, {bool animate = false}) =>
  ...
  Widget onLongPressTap({GestureLongPressCallback? onLongPress}) =>
      InkWell(onLongPress: onLongPress, child: this);
