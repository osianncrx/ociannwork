...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    const countryCodes = [
      ...
      { code: '+672', country: 'Australian Antarctic Territory', flag: '🇦🇶' },
    ...
    const countryCodesWithTimestamps = countryCodes.map((item, index) => ({
      id: index + 1,
      ...item,
      created_at: new Date(),
      updated_at: new Date()
    ...
    await queryInterface.bulkInsert('country_codes', countryCodesWithTimestamps, {});
  },
