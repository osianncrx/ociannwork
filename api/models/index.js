...
db.CountryCode = require('./country-code.model')(sequelize, DataTypes);
...
db.MutedChat = require('./muted-chat')(sequelize, DataTypes);
...
db.Reminder = require('./reminder.model')(sequelize, DataTypes);
